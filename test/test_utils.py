...
def test_iter_files():
    with tempfile.TemporaryDirectory() as _tempdir:
        ...
        assert set(iter_files([top_level_dir, top_level_file])) == {
            ("top_level_file", top_level_file),
            ("top_level_dir/nested_file.txt", nested_file),
            ("top_level_dir/nested_dir/doubly_nested_file.csv", doubly_nested_file),
        }
